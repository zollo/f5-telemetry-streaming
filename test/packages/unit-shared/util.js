...
const avrData = require('./data/avrData.json');
const ltmData = require('./data/ltmData.json');
const utRuntime = require('./runtime');

const systemPollerData = rootDir.import('examples/output/system_poller/output.json');
const requestLib = rootDir.appImport('node_modules/@cypress/request');
...
const _module = module.exports = {
    ...
    smokeTests: {
         ...
         */
        ignore(value) {
            return utRuntime.SMOKE_TESTING_ENABLED ? SMOKE_TEST_SYMB : value;
        }
    },
