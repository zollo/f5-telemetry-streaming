...
// preload most used libs here for optimization
const { resolve, rootDir } = require('@f5-telemetry-tests/common/rootdir');

const BASE_DIR = rootDir();
const SRC_DIR = resolve('application');

/**
 * Verify that modules from '/application' are not cached
 *
 ...
 * @param {boolean} [allowSrcDir] - allow modules from './application' directory in cache
 */
...
module.exports = (function () {
    ...
    // just to be sure that modules from /application are not imported yet
    checkCache(require.cache);
