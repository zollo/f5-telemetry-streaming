...
const testDataLocalHost = [
    ...
    {
        value: { token: 10 },
        error: /token should be a string/
    },
    {
        value: { username: 10 },
    ...
    {
        value: { token: 'token', username: 10 },
        error: /username should be a string/
    },
    {
        value: { token: 'token', username: '' },
        error: /username should be a non-empty collection/
    },
    {
        value: { token: 'token', username: 'test_user_1', passphrase: '' },
        error: /passphrase should be a non-empty collection/
    },
    {
        value: { token: 'token', username: 'test_user_1', passphrase: 10 },
        error: /passphrase should be a string/
    }
];
const testDataRemoteHost = [
    {
        value: undefined,
    ...
    {
        value: { username: 'test_user_1', passphrase: 'test_passphrase_1', token: null },
        error: /token should be a string/
    },
    {
        value: { token: 'token', username: 10 },
...
module.exports = (host) => deepCopy(host === 'localhost' ? testDataLocalHost : testDataRemoteHost);
