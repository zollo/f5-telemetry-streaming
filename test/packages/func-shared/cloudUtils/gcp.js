...
/**
 * @module func-shared/cloudUtils/gcp
 */
...
/**
 * Get Google Cloud Monitoring Metrics Descriptors
 *
 * @public
 *
 * @param {string} accessToken
 ...
 */
function getCloudMonitoringDescriptors(accessToken, projectID, cloudType) {
    const gcp = getGCP(cloudType);
    return request({
        headers: {
            Authorization: `Bearer ${accessToken}`
        ...
        port: 443,
        protocol: 'https',
        uri: `/v3/projects/${projectID}/metricDescriptors`
    });
}

module.exports = {
    getCloudMonitoringDescriptors,
    getOAuthToken,
