...
const DOCKER_IMAGES_CLEANUP = miscUtils.getEnvArg(constants.ENV_VARS.TEST_CONTROLS.CONSUMER.DOCKER_CLEANUP, { castTo: 'boolean', defaultValue: false });
