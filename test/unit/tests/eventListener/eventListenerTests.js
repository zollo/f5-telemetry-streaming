...
const configWorker = rootDir.appImport('lib/config');
const dataPipeline = rootDir.appImport('lib/dataPipeline');
const EventListener = rootDir.appImport('lib/eventListener');
// const messageStream = rootDir.appImport('lib/eventListener/messageStream');
const tracerMgr = rootDir.appImport('lib/tracerManager');
const utilMisc = rootDir.appImport('lib/utils/misc');

moduleCache.remember();

describe.skip('Event Listener', () => {
    let messageStream;
