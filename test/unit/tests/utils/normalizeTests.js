...
const normalizeUtil = rootDir.appImport('lib/utils/normalize');
...
describe('Normalize Util', () => {
    ...
    describe('.addFqdnToLtmPool()', () => {
        ...
        it('should not fail when no pool member config data', () => {
            ...
            const expected = testUtil.deepCopy(args.data);
    ...
    describe('ASM Functions', () => {
        ...
        describe('.getAsmState', () => {
            ...
            it('should return \'Pending Policy Changes\' when a policy is modified', () => {
                const actual = testUtil.deepCopy(inputData);
                actual.data.push({
                    createdDatetime: '2020-01-04T17:32:44Z',
                    name: 'Policy_four',
                    versionDatetime: '2020-01-17T17:34:32Z',
        ...
        describe('.getAsmAttackSignatures', () => {
            ...
            const oneSignatureWithBadStatus = testUtil.deepCopy(oneSignatureWithoutStatus);
            ...
            const oneSignatureWithGoodStatus = testUtil.deepCopy(oneSignatureWithoutStatus);
