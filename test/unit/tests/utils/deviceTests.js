...
const constants = rootDir.appImport('lib/constants');
const deviceUtil = rootDir.appImport('lib/utils/device');
const utilMisc = rootDir.appImport('lib/utils/misc');
