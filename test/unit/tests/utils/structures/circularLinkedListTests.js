...
const CircularLinkedList = rootDir.appImport('lib/utils/structures').CircularLinkedList;
const CircularLinkedListMR = rootDir.appImport('lib/utils/structures').CircularLinkedListMR;
