...
const util = rootDir.appImport('lib/utils/misc');
...
const OTLP_PROTOS_PATH = path.resolve(__dirname, '../../node_modules/@opentelemetry/opentelemetry-proto');
...
const OTLP_PROTO_GEN_PATH = 'node_modules/@opentelemetry/otlp-grpc-exporter-base/build/src/generated/root.js';
...
if (IS_8_11_1_PLUS) {
    ...
    grpc = rootDir.appImport('node_modules/@grpc/grpc-js');
    // eslint-disable-next-line global-require
    openTelemetryExporter = rootDir.appImport('lib/consumers/OpenTelemetry_Exporter/index');
    // eslint-disable-next-line global-require, import/no-dynamic-require
    openTelemetryProtoGen = rootDir.appImport(OTLP_PROTO_GEN_PATH);
    // eslint-disable-next-line global-require
    protoLoader = rootDir.appImport('node_modules/@grpc/proto-loader');
}
