...
const AWS = rootDir.appImport('node_modules/aws-sdk');
const awsCloudWatchIndex = rootDir.appImport('lib/consumers/AWS_CloudWatch/index');
const awsUtil = rootDir.appImport('lib/consumers/shared/awsUtil');
