...
const appInsights = rootDir.appImport('node_modules/applicationinsights');
const appInsightsLogging = rootDir.appImport('node_modules/applicationinsights/out/Library/Logging');
const azureAppInsightsIndex = rootDir.appImport('lib/consumers/Azure_Application_Insights/index');
