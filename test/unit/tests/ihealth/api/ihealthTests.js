...
const httpProxyTests = require('@f5-telemetry-tests/unit-shared/tests/httpProxy');
const ihealthCredsTests = require('@f5-telemetry-tests/unit-shared/tests/ihealthCreds');
...
const IHealthAPI = rootDir.appImport('lib/ihealth/api/ihealth');
const logger = rootDir.appImport('lib/logger');
const { SERVICE_API } = rootDir.appImport('lib/constants').IHEALTH;
