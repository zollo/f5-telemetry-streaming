...
describe('iHealth / iHealth Service', () => {
    ...
    describe('configuration variations', () => {
        ...
        combinations.forEach(([intervalConf, proxyConf, systemAuthConf, systemConf, namespaceConf], idx) => describe(
            `(${idx + 1} / ${combinations.length}) interval = ${intervalConf.name}, proxy = ${proxyConf.name}, system = ${systemConf.name}, systemAuth = ${systemAuthConf.name}, namespace = ${namespaceConf.name}`,
            () => {
