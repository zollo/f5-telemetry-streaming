...
const packageInfo = rootDir.appImport('package.json');
const schemaInfo = rootDir.appImport('schema/latest/base_schema.json').properties.schemaVersion.enum;

moduleCache.remember();

describe('Application Info (appInfo.js)', () => {
    const packageJSONFilePath = rootDir.appResolve('package.json');
    let appInfo;
    let packageJSONRaw;
    let packageJSON;
    ...
    it('should provide application info (release)', () => {
        ...
        appInfo = rootDir.appImport('lib/appInfo');
        assert.deepStrictEqual(appInfo, {
            branch: utRuntime.RPM_TESTING_ENABLED ? packageInfo.gitbranch : 'gitbranch',
            buildID: utRuntime.RPM_TESTING_ENABLED ? packageInfo.githash : 'githash',
            ...
            timestamp: utRuntime.RPM_TESTING_ENABLED ? packageInfo.buildtimestamp : 'buildtimestamp',
