...
module.exports = {
    ...
    tests: [
         ...
         * */
        {
            ...
            endpoints: [
                {
                    endpoint: '/mgmt/tm/ltm/virtual?%24top=30',
                    response: {
         ...
         * */
        {
            name: 'should collect virtual servers stats and expand profilesReference and use nextLink (pagination)',
            statsToCollect: ['virtualServers'],
            expectedData: {
                virtualServers: {
                    '/Common/test_vs_0': {
                    ...
                    '/Common/test_vs_1': {
                        ...
                        ipProtocol: 'tcp',
                        mask: '255.255.255.255',
                        name: '/Common/test_vs_1',
                        pool: '/Common/test_pool_1',
                        profiles: {
                            '/Common/f5-tcp-lan-1': {
                                name: '/Common/f5-tcp-lan-1',
                                tenant: 'Common'
                            },
                            '/Common/http-1': {
                                name: '/Common/http-1',
                            ...
                            '/Common/http-proxy-connect-1': {
                                name: '/Common/http-proxy-connect-1',
                                tenant: 'Common'
                            },
                            '/Common/tcp-1': {
                                name: '/Common/tcp-1',
            ...
            endpoints: [
                {
                    ...
                    response: {
                        kind: 'tm:ltm:virtual:virtualcollectionstate',
                        selfLink: 'https://localhost/mgmt/tm/ltm/virtual?ver=14.1.0',
                        nextLink: 'https://localhost/mgmt/tm/ltm/virtual?%24skip=30&%24top60',
                        items: [
                            {
                                name: 'test_vs_0',
                                fullPath: '/Common/test_vs_0',
                ...
                {
                    endpoint: '/mgmt/tm/ltm/virtual?%24skip=30&%24top60',
                    response: {
                        kind: 'tm:ltm:virtual:virtualcollectionstate',
                        selfLink: 'https://localhost/mgmt/tm/ltm/virtual?ver=14.1.0',
                        items: [
                            {
                                name: 'test_vs_0',
                                fullPath: '/Common/test_vs_1',
                                selfLink: 'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_1?ver=14.1.0',
                                ipProtocol: 'tcp',
                                mask: '255.255.255.255',
                                pool: '/Common/test_pool_1',
                                poolReference: {
                                    link: 'https://localhost/mgmt/tm/ltm/pool/~Common~test_pool_1?ver=14.1.0'
                                },
                                profilesReference: {
                                    link: 'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_1/profiles?ver=14.1.0',
                                    isSubcollection: true
                                }
                            }
                        ]
                ...
                {
                    endpoint: '/mgmt/tm/ltm/virtual/~Common~test_vs_1/stats',
                    response: {
                        kind: 'tm:ltm:virtual:virtualstats',
                        selfLink: 'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_1/stats?ver=14.1.0',
                        entries: {
                            'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_1/stats': {
                                nestedStats: {
                                    kind: 'tm:ltm:virtual:virtualstats',
                                    selfLink: 'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_1/stats?ver=14.1.0',
                                    entries: {
                ...
                },
                {
                    ...
                    response: {
                        kind: 'tm:ltm:virtual:profiles:profilescollectionstate',
                        selfLink: 'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_0/profiles?$select=name%2CfullPath&ver=14.1.0',
                        items: [
                            {
                                name: 'f5-tcp-lan',
                                fullPath: '/Common/f5-tcp-lan'
                ...
                {
                    endpoint: '/mgmt/tm/ltm/virtual/~Common~test_vs_1/profiles?$select=name,fullPath',
                    response: {
                        kind: 'tm:ltm:virtual:profiles:profilescollectionstate',
                        selfLink: 'https://localhost/mgmt/tm/ltm/virtual/~Common~test_vs_1/profiles?$select=name%2CfullPath&ver=14.1.0',
                        items: [
                            {
                                name: 'f5-tcp-lan-1',
                                fullPath: '/Common/f5-tcp-lan-1'
                            },
                            {
                                name: 'http-1',
                                fullPath: '/Common/http-1'
                            },
                            {
                                name: 'http-proxy-connect-1',
                                fullPath: '/Common/http-proxy-connect-1'
                            },
                            {
                                name: 'tcp-1',
                                fullPath: '/Common/tcp-1'
                            }
                        ]
                    }
                }
