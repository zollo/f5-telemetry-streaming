    ...
    tests: [
         ...
         * */
        {
            ...
            endpoints: [
                ...
                {
                    endpoint: '/mgmt/tm/net/interface/stats?%24top=30',
                    response: {
                        kind: 'tm:net:interface:interfacecollectionstats',
                        selfLink: 'https://localhost/mgmt/tm/net/interface/stats?ver=14.1.0',
                        nextLink: 'https://localhost/mgmt/tm/net/interface/stats?%24top=60&%24skip=30',
                        entries: {
                ...
                {
                    endpoint: '/mgmt/tm/net/interface/stats?%24top=60&%24skip=30',
                    response: {
                        kind: 'tm:net:interface:interfacecollectionstats',
                        selfLink: 'https://localhost/mgmt/tm/net/interface/stats?ver=14.1.0',
                        entries: {
                ...
                {
                    endpoint: '/mgmt/tm/asm/policies?%24top=30',
                    response: {
         ...
         * */
        {
            ...
            expectedData: {
                system: {
                    ...
                    configReady: 'missing data',
                    provisionReady: 'missing data',
                    licenseReady: 'missing data',
