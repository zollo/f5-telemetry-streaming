...
const Collector = rootDir.appImport('lib/systemPoller/collector');
const defaultPaths = rootDir.appImport('lib/paths.json');
const defaultProperties = rootDir.appImport('lib/properties.json');
...
const testsDataPath = pathResolve(__dirname, './data/defaultProperties');
