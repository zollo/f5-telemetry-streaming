...
const appInfo = rootDir.appImport('lib/appInfo');
const TeemDevice = rootDir.appImport('node_modules/@f5devcentral/f5-teem').Device;
const TeemReporterService = rootDir.appImport('lib/teemReporter');
