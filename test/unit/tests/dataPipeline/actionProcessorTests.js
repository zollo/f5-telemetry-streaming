...
const actionProcessor = rootDir.appImport('lib/dataPipeline/actionProcessor');
const dataUtil = rootDir.appImport('lib/utils/data');
const dataTagging = rootDir.appImport('lib/dataPipeline/dataTagging');
const EVENT_TYPES = rootDir.appImport('lib/constants').EVENT_TYPES;
