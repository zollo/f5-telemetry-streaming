...
const CLOUD_LOGGING_PROTOCOL = 'https';
...
module.exports = function (context) {
    ...
    const httpAgent = getHttpAgent(Object.assign({ connection: { protocol: CLOUD_LOGGING_PROTOCOL } }, context.config));

    return gcpUtil.getAccessToken(serviceAccount, httpAgent)
        .then((accessToken) => {
            const entries = [];
